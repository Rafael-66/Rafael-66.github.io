...
function Card(props:any){
    ...
    function parseData(i:any){
        if (i == 0){
            ...
            <text x={props.x+60} y={pos+125} textAnchor="middle" fontSize="100" fill="white" stroke="black" strokeWidth="2" onMouseEnter={hover} onMouseLeave={hoverEnd} onClick={click}>{props.number}</text>
            </>)
        } else if (i == 1) {
            return (<>
